  ...
  render() {
    return (
      <div className="container Example">
        ...
        {`${this.state.name} уриа: ${this.state.motto}`}<br></br>
          
          <p>Change:</p><input id="mottoInput" type="text" value={this.state.motto} onChange={event => this.handleMottoChange(event)} />
        </div>
